...
int64_t GetIntegerUpperLimitForType(torch::ScalarType dtype) {
  switch (TensorTypeToRawXlaType(dtype)) {
    case xla::PrimitiveType::S8:
      return static_cast<int64_t>(std::numeric_limits<xla::int8>::max());
    case xla::PrimitiveType::U8:
      return static_cast<int64_t>(std::numeric_limits<xla::uint8>::max());
    case xla::PrimitiveType::S16:
      return static_cast<int64_t>(std::numeric_limits<xla::int16>::max());
    case xla::PrimitiveType::U16:
      return static_cast<int64_t>(std::numeric_limits<xla::uint16>::max());
    case xla::PrimitiveType::S32:
      return static_cast<int64_t>(std::numeric_limits<xla::int32>::max());
    case xla::PrimitiveType::U32:
      return static_cast<int64_t>(std::numeric_limits<xla::uint32>::max());
    case xla::PrimitiveType::S64:
      return static_cast<int64_t>(std::numeric_limits<xla::int64>::max());
    case xla::PrimitiveType::U64:
      return static_cast<int64_t>(std::numeric_limits<xla::uint64>::max());
    ...
    case xla::PrimitiveType::PRED:
      return static_cast<int64_t>(1);
    default:
      XLA_ERROR() << "Unsupported XLA type " << TensorTypeToRawXlaType(dtype)
                  << " from scalar type " << dtype;
  }
}
